    ...
    <SwiperSlide>
      ...
      <div className="auto-container">
        <div className="slider-seven__content">
          ...
          <span className="sliderspan">We Believe in making more with less</span>
            {title.split(" ").map((t, i) => (
              <Fragment key={i}>
          ...
          <a href="/portfolio" className="slider-seven__btn thm-btn__seven">
          View Work
          </a>
          <a href="/contact" className="slider-seven__btn thm-btn__seven2">
          Request A Qoute
          </a>
        </div>
      </div>
