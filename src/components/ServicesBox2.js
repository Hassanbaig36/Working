      ...
      <>
        ...
        <Fade bottom>
          <div className="card">
            ...
            <div className="text">DIGITALIZATION</div>
            <p className="servicesp">
            Crafting smart and streamlined digital remedies for automating labor-intensive and ineffective corporate workflows, driving efficiency and growth.
          </p>
          </div>
          </Fade>
          <style jsx>{`
