      ...
      <>
        ...
        <Fade top>
          <div className="card">
            ...
            <div className="text">MODERNIZATION</div>
            <p className="servicesp">
            Revamping outdated technology to enhance speed, scalability, security, and user experiences, promoting optimal performance.
          </p>
          </div>
  </Fade>
  <style jsx>{`
